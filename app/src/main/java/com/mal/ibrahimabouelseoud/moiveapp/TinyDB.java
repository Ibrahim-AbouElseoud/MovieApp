...
public class TinyDB {
    ...
    public void putListMovie(String key, ArrayList<Movie> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Movie obj : objArray){
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }

    public ArrayList<Movie> getListMovie(String key, Class<Movie> mClass){
        Gson gson = new Gson();
        ...
        for(String jObjString : objStrings){
            Movie value  = gson.fromJson(jObjString,  mClass);
            objects.add(value);
        }
        return objects;
    }
